...
class Sales_View_Zoom_IM_HC_MVC extends _HC_MVC
{
	public function render( $model )
	{
		...
		switch( $model['status'] ){
			case $model_obj->_const('STATUS_CONFIRMED'):
			case $model_obj->_const('STATUS_SHIPPED'):
			case $model_obj->_const('STATUS_PARTIALLY_SHIPPED'):
